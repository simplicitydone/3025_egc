export const RAW_CHORDS = {
    ...
    'Am11 (High Drone)': { tier: 'Advanced', subCategory: 'High Drone', frets: ['X', '12', '12', '0', '10', '0'], fingers: ['', '2', '3', '', '1', ''], rootString: 5, bassNote: 'A', description: 'ii chord up high.' },
    ...
    'Dadd4 (High Drone)': { tier: 'Advanced', subCategory: 'High Drone', frets: ['10', 'X', '12', '0', '10', '0'], fingers: ['1', '', '3', '', '2', ''], rootString: 6, bassNote: 'D', description: 'V chord up high.' },
    ...
    'Em11 (High Drone)': { tier: 'Advanced', subCategory: 'High Drone', frets: ['X', '7', '7', '0', '5', '0'], fingers: ['', '2', '3', '', '1', ''], rootString: 5, bassNote: 'E', description: 'ii chord cinematic.' },
    ...
    'Emaj9': { tier: 'Advanced', subCategory: 'Extensions', frets: ['0', '2', '1', '1', '0', '2'], fingers: ['', '2', '1', '1', '', '3'], rootString: 6, bassNote: 'E' },
    // ==========================================
    ...
    'Cmaj7 (D2 Mid 1st)': { tier: 'Advanced', subCategory: 'Drop-2 (Mid)', frets: ['X', '7', '9', '5', '8', 'X'], fingers: ['', '2', '4', '1', '3', ''], rootString: 5, bassNote: 'E' },
    ...
    'Gmaj7 (D3 2nd)': { tier: 'Advanced', subCategory: 'Drop-3', frets: ['10', 'X', '9', '11', '8', 'X'], fingers: ['3', '', '2', '4', '1', ''], rootString: 6, bassNote: 'D' },
    'Gmaj7 (D3 3rd)': { tier: 'Advanced', subCategory: 'Drop-3', frets: ['14', 'X', '12', '12', '12', 'X'], fingers: ['3', '', '1', '1', '1', ''], rootString: 6, bassNote: 'F#' },
    ...
    'Gm7 (D3 2nd)': { tier: 'Advanced', subCategory: 'Drop-3 Minor', frets: ['10', 'X', '8', '10', '8', 'X'], fingers: ['3', '', '1', '4', '1', ''], rootString: 6, bassNote: 'D' },
    ...
    'Gmaj7 (Play Bm)': { tier: 'Advanced', subCategory: 'Upper Structure', frets: ['X', 'X', 'X', '7', '7', '7'], fingers: ['', '', '', '1', '1', '1'], rootString: 3, bassNote: 'D', description: 'Bm triad over G bass.' },
    ...
    // ==========================================
    'G Maj (Top Root)': { tier: 'Basic', subCategory: 'Triads', frets: ['X', 'X', 'X', '12', '12', '10'], fingers: ['', '', '', '2', '3', '1'], rootString: 3, bassNote: 'G' },
    ...
    'Csus2 (Pad)': { tier: 'Advanced', subCategory: 'Ambient', frets: ['X', '3', '5', '5', '3', 'X'], fingers: ['', '1', '3', '4', '1', ''], rootString: 5, bassNote: 'C', description: 'Dense stacked 2nd' },
    ...
    'Badd11 (High Drone)': { tier: 'Advanced', subCategory: 'High Drone', frets: ['7', '9', '9', '8', '0', '0'], fingers: ['1', '3', '4', '2', '', ''], rootString: 6, bassNote: 'B', description: 'Massive I chord — open E adds the 11.' },
    ...
    'Gm13 (Open)': { tier: 'Basic', subCategory: 'Standard', frets: ['3', 'X', '3', '3', '3', '0'], fingers: ['T', '', '1', '1', '1', ''], rootString: 6, bassNote: 'G', description: 'Open e rings the 13.' },
    ...
    'G 6ths (Root)': { tier: 'Basic', subCategory: 'Double Stop', frets: ['X', 'X', '5', 'X', '3', 'X'], fingers: ['', '', '3', '', '1', ''], rootString: 4, bassNote: 'G', description: 'Country/R&B staple' },
    'G 6ths (1st Inv)': { tier: 'Basic', subCategory: 'Double Stop', frets: ['X', 'X', '9', 'X', '8', 'X'], fingers: ['', '', '3', '', '2', ''], rootString: 2, bassNote: 'B' },
    ...
    // Hendrix Box
    'Am7 (Hendrix Box)': { tier: 'Advanced', subCategory: 'Embellishment', frets: ['5', 'X', '5', '5', '5', '5'], fingers: ['T', '', '1', '1', '1', '1'], rootString: 6, bassNote: 'A', description: 'Thumb root allows pinky embellishments' },
    ...
    // ==========================================
    // OPEN TENSION FORMS (open 1st & 2nd strings)
    // Slide the fretted shape; the open B & E strings supply the tensions.
    // ==========================================
    // Form 1: E-shape (strings 6-5-4-3 fretted)
    'Fmaj7#11 (Form 1)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['1', '3', '3', '2', '0', '0'], fingers: ['1', '3', '4', '2', '', ''], rootString: 6, bassNote: 'F', description: 'E shape at 1fr — use instead of plain F for a dreamy Lydian color.' },
    'F#7add11 (Form 1)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['2', '4', '4', '3', '0', '0'], fingers: ['1', '3', '4', '2', '', ''], rootString: 6, bassNote: 'F#', description: 'Use instead of F#7 — open B is the 11.' },
    'G6 (Form 1)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['3', '5', '5', '4', '0', '0'], fingers: ['1', '3', '4', '2', '', ''], rootString: 6, bassNote: 'G', description: 'Use instead of G — open e adds the 6.' },
    'Aadd9 (Form 1)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['5', '7', '7', '6', '0', '0'], fingers: ['1', '3', '4', '2', '', ''], rootString: 6, bassNote: 'A', description: 'The A-key workhorse — open B is the 9.' },
    'Cmaj7 (Form 1)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['8', '10', '10', '9', '0', '0'], fingers: ['1', '3', '4', '2', '', ''], rootString: 6, bassNote: 'C', description: 'Use instead of C — open B is the maj7.' },
    'D6/9 (Form 1)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['10', '12', '12', '11', '0', '0'], fingers: ['1', '3', '4', '2', '', ''], rootString: 6, bassNote: 'D', description: 'Use instead of D — 6 and 9 ring on top.' },
    // Form 2: Asus2 shape (strings 5-4-3 fretted)
    'Cmaj7 (Form 2)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '3', '5', '5', '0', '0'], fingers: ['', '1', '3', '4', '', ''], rootString: 5, bassNote: 'C', description: 'Asus2 shape at 3fr — use instead of C.' },
    'D6sus2 (Form 2)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '5', '7', '7', '0', '0'], fingers: ['', '1', '3', '4', '', ''], rootString: 5, bassNote: 'D', description: 'Use instead of D — floating sus2 with a 6 on top.' },
    'G6 (Form 2)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '10', '12', '12', '0', '0'], fingers: ['', '1', '3', '4', '', ''], rootString: 5, bassNote: 'G', description: 'High-fret extension of the form.' },
    // Form 3: F#m7(add11) shape (strings 6-4-3 fretted, 5th string muted)
    'G#m7b13 (Form 3)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['4', 'X', '4', '4', '0', '0'], fingers: ['1', '', '2', '3', '', ''], rootString: 6, bassNote: 'G#', description: 'Dark minor color — open E is the b13.' },
    'Am9 (Form 3)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['5', 'X', '5', '5', '0', '0'], fingers: ['1', '', '2', '3', '', ''], rootString: 6, bassNote: 'A', description: 'Full Am9 — open B is the 9.' },
    'C#m7 (Form 3)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['9', 'X', '9', '9', '0', '0'], fingers: ['1', '', '2', '3', '', ''], rootString: 6, bassNote: 'C#', description: '5th omitted — the open-string nuance still carries.' },
    'D#m7 (Form 3)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['11', 'X', '11', '11', '0', '0'], fingers: ['1', '', '2', '3', '', ''], rootString: 6, bassNote: 'D#', description: '5th omitted; open strings rub (b9) — passing color, mind the clash.' },
    'Em7 (Form 3)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['12', 'X', '12', '12', '0', '0'], fingers: ['1', '', '2', '3', '', ''], rootString: 6, bassNote: 'E', description: 'Top of the form — pure Em7 at the octave.' },
    // Form 4: C#m7 high-position shape (strings 6-5-4-3 fretted)
    'G#m b13 (Form 4)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['4', '6', '6', '4', '0', '0'], fingers: ['1', '3', '4', '1', '', ''], rootString: 6, bassNote: 'G#', description: 'Fuller G#m — open E adds the b13 shimmer.' },
    'Am add9 (Form 4)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['5', '7', '7', '5', '0', '0'], fingers: ['1', '3', '4', '1', '', ''], rootString: 6, bassNote: 'A', description: 'Use instead of Am.' },
    'Bm add11 (Form 4)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['7', '9', '9', '7', '0', '0'], fingers: ['1', '3', '4', '1', '', ''], rootString: 6, bassNote: 'B', description: 'Use instead of Bm.' },
    'C#m7 (Form 4)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['9', '11', '11', '9', '0', '0'], fingers: ['1', '3', '4', '1', '', ''], rootString: 6, bassNote: 'C#', description: 'The 9fr hi-position C#m7 — full voicing with 5th.' },
    // Form 5: 1st-inversion slash shape (strings 5-4-3 fretted)
    'Aadd9/C# (Form 5)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '4', '2', '2', '0', '0'], fingers: ['', '3', '1', '2', '', ''], rootString: 5, bassNote: 'C#', description: '1st-inversion A — use for A/C#, open B is the 9.' },
    'Bsus4/D# (Form 5)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '6', '4', '4', '0', '0'], fingers: ['', '3', '1', '2', '', ''], rootString: 5, bassNote: 'D#', description: 'Rising bass line — two frets up from A/C#.' },
    'Cmaj7/E (Form 5)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '7', '5', '5', '0', '0'], fingers: ['', '3', '1', '2', '', ''], rootString: 5, bassNote: 'E', description: 'Use for C/E — open B turns it maj7.' },
    'D6/9/F# (Form 5)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '9', '7', '7', '0', '0'], fingers: ['', '3', '1', '2', '', ''], rootString: 5, bassNote: 'F#', description: 'Use for D/F# in ascending bass runs.' },
    'E/G# (Form 5)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '11', '9', '9', '0', '0'], fingers: ['', '3', '1', '2', '', ''], rootString: 5, bassNote: 'G#', description: 'The E-key resolution point of the climb.' },
    // Form 6: E/G# low slash shape (strings 6-4-3 fretted)
    'Fmaj7#11/A (Form 6)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['5', 'X', '3', '5', '0', '0'], fingers: ['2', '', '1', '3', '', ''], rootString: 6, bassNote: 'A', description: 'Use for F/A — half-step riser with open-string haze.' },
    'F#7add11/A# (Form 6)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['6', 'X', '4', '6', '0', '0'], fingers: ['2', '', '1', '3', '', ''], rootString: 6, bassNote: 'A#', description: 'Use for F#/A# — keeps the chromatic bass climbing.' },
    'G6/B (Form 6)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['7', 'X', '5', '7', '0', '0'], fingers: ['2', '', '1', '3', '', ''], rootString: 6, bassNote: 'B', description: 'Use for G/B at the top of the climb.' },
    'D6/9/F# (Form 6)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['2', 'X', '0', '2', '0', '0'], fingers: ['1', '', '', '2', '', ''], rootString: 6, bassNote: 'F#', description: 'Use for D/F# in descending bass lines.' },
    // Form 7: G6/B one-finger walk (open-position start)
    'G6/B (Form 7)': { tier: 'Advanced', subCategory: 'Open Tension', frets: ['X', '2', '0', '0', '0', '0'], fingers: ['', '1', '', '', '', ''], rootString: 5, bassNote: 'B', description: 'One finger — B bass under a ringing G6.' }
};
export const CHORD_LIBRARY = Object.fromEntries(Object.entries(RAW_CHORDS).map(([name, data]) => [name, { ...data, name }]));
