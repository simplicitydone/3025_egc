...
export const ELECTRIC_CHORDS = [
    ...
    { groupName: 'Ambient Clusters', description: 'Dense stacked 2nds for volume swells and heavy reverb pads.', chords: [CHORD_LIBRARY['Csus2 (Pad)'], CHORD_LIBRARY['Emaj9 (Cluster)'], CHORD_LIBRARY['D add9 (Cluster)']] },
    { groupName: 'Thumb-Root Embellishment', description: 'Hendrix / Mayer style: thumb takes the bass so fingers are free to decorate.', chords: [CHORD_LIBRARY['Am7 (Hendrix Box)'], CHORD_LIBRARY['Fmaj7 (Thumb)'], CHORD_LIBRARY['Gm13 (Open)']] },
