...
import { TENSION_FORMS } from './data/tension'
...
export default function App() {
  ...
  const [selectedTensionIdx, setSelectedTensionIdx] = useState(0)
  const [selectedTensionChord, setSelectedTensionChord] = useState<Chord>(
    TENSION_FORMS[0].chords[0],
  )
  ...
  const handleTensionChange = (i: number) => {
    setSelectedTensionIdx(i)
    setSelectedTensionChord(TENSION_FORMS[i].chords[0])
  }
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        {tab === 'tension' && (
          <TensionView
            selectedFormIdx={selectedTensionIdx}
            onFormChange={handleTensionChange}
            selectedChord={selectedTensionChord}
            onSelectChord={setSelectedTensionChord}
          />
        )}
