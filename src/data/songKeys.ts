...
export const SONG_KEYS: KeyGroup[] = [
  ...
  { keyName: 'Key of B', chords: [
    ...
    { chord: CHORD_LIBRARY['Badd11 (High Drone)'], nashville: 'I (High)' }, { chord: CHORD_LIBRARY['Emaj9 (High Drone)'], nashville: 'IV (High)' }
  ]},
  { keyName: 'Key of F (Thumb)', chords: [
    { chord: CHORD_LIBRARY['Fmaj7 (Thumb)'], nashville: 'I' }, { chord: CHORD_LIBRARY['Gm13 (Open)'], nashville: 'ii' }, { chord: CHORD_LIBRARY['Bb2 (Open)'], nashville: 'IV' }
  ]},
